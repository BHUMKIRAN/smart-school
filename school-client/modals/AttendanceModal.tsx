        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-t-3xl px-6 py-5 relative">
          ...
          <div className="pr-8">
            ...
            <div className="flex items-center gap-2 text-white/90">
              <div className={`w-2 h-2 rounded-full ${isUpdating ? 'bg-green-400' : 'bg-white/60'} animate-pulse`}></div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 p-5 border border-green-100">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-green-600">{teacherData.rate}%</p>
              </div>
            </div>
