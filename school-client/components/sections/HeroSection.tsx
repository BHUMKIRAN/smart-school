    ...
    >
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-left duration-1000 order-1 lg:order-1">
            ...
            <p className="text-lg text-primary leading-relaxed max-w-lg">{subtitle}</p>
          </div>

          {/* --- Right Column: Hero Images --- */}
          <div className="relative h-[420px] md:h-[520px] w-full order-2 lg:order-2 mb-6 lg:mb-0">
          ...
          {/* --- Premium Mini Stats --- */}
          <div className="flex flex-col sm:flex-row items-center justify-around gap-6 pt-6 order-3 lg:order-3">
            <div className="flex flex-col items-center">
              <p className="text-3xl sm:text-2xl font-black text-primary">480+</p>
              <p className="text-xs sm:text-sm font-bold text-accent uppercase tracking-widest nepali-text">विद्यार्थी</p>
            </div>
            <div className="flex flex-col items-center">
              <p className="text-3xl sm:text-2xl font-black text-primary">28</p>
              <p className="text-xs sm:text-sm font-bold text-accent uppercase tracking-widest nepali-text">शिक्षक</p>
            </div>
            <div className="flex flex-col items-center">
              <p className="text-3xl sm:text-2xl font-black text-primary">15+</p>
              <p className="text-xs sm:text-sm font-bold text-accent uppercase tracking-widest nepali-text">वर्ष अनुभव</p>
            </div>
          </div>

          {/* --- CTA Buttons: last on mobile --- */}
          <div className="flex flex-col sm:flex-row gap-5 pt-4 order-4 lg:order-1">
            <a
              href="#about"
